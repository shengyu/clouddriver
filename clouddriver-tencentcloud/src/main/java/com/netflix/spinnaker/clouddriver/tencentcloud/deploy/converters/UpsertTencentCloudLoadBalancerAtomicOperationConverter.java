...
import com.netflix.spinnaker.clouddriver.tencentcloud.deploy.ops.UpsertTencentCloudLoadBalancerAtomicOperation;
import java.util.Map;
import org.springframework.stereotype.Component;

@TencentCloudOperation(AtomicOperations.UPSERT_LOAD_BALANCER)
@Component("upsertTencentCloudLoadBalancerDescription")
public class UpsertTencentCloudLoadBalancerAtomicOperationConverter
    extends AbstractAtomicOperationsCredentialsSupport {

  @Override
  public AtomicOperation convertOperation(Map input) {
    UpsertTencentCloudLoadBalancerDescription description = convertDescription(input);
    ...
    return new UpsertTencentCloudLoadBalancerAtomicOperation(lbClient, description);
  }

  @Override
  public UpsertTencentCloudLoadBalancerDescription convertDescription(Map input) {
    UpsertTencentCloudLoadBalancerDescription description =
        getObjectMapper().convertValue(input, UpsertTencentCloudLoadBalancerDescription.class);
