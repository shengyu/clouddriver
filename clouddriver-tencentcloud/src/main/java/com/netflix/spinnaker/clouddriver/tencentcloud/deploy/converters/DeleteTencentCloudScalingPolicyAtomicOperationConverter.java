...
import com.netflix.spinnaker.clouddriver.tencentcloud.deploy.ops.DeleteTencentScalingPolicyAtomicOperation;
import java.util.Map;
import org.springframework.stereotype.Component;

@TencentCloudOperation(AtomicOperations.DELETE_SCALING_POLICY)
@Component("deleteTencentCloudScalingPolicyDescription")
public class DeleteTencentCloudScalingPolicyAtomicOperationConverter
    extends AbstractAtomicOperationsCredentialsSupport {

  @Override
  public AtomicOperation convertOperation(Map input) {
    DeleteTencentCloudScalingPolicyDescription description = convertDescription(input);
    ...
    return new DeleteTencentScalingPolicyAtomicOperation(asClient, description);
  }

  @Override
  public DeleteTencentCloudScalingPolicyDescription convertDescription(Map input) {
    DeleteTencentCloudScalingPolicyDescription description =
        getObjectMapper().convertValue(input, DeleteTencentCloudScalingPolicyDescription.class);
