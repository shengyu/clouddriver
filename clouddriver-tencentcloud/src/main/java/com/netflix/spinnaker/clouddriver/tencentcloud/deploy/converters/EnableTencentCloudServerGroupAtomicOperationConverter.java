...
import com.netflix.spinnaker.clouddriver.tencentcloud.deploy.ops.EnableTencentCloudServerGroupAtomicOperation;
import java.util.Map;
import org.springframework.stereotype.Component;

@TencentCloudOperation(AtomicOperations.ENABLE_SERVER_GROUP)
@Component("enableTencentCloudServerGroupDescription")
public class EnableTencentCloudServerGroupAtomicOperationConverter
  ...
  public AtomicOperation convertOperation(Map input) {
    ...
    return new EnableTencentCloudServerGroupAtomicOperation(asClient, description);
  }
